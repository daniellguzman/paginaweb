...
================================================== -->
  <body>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          <img class="first-slide" src="img/img2.jpg " alt="First slide">
          <div class="container">
    ...
    <div class="container marketing">
      ...
      <div class="row">
        <div class="col-lg-4">
          <img class="img-circle" src="img/python.jpg " alt="Generic placeholder image" width="140" height="140">
          <h2>Python</h2>
...
Se trata de un lenguaje de programación multiparadigma, ya que soporta orientación a objetos, programación imperativa y, en menor medida, programación funcional. Es un lenguaje interpretado, usa tipado dinámico y es multiplataforma.</p>
        ...
        <div class="col-lg-4">
          <img class="img-circle" src="img/java.jpg" alt="Generic placeholder image" width="160" height="160">
          <h2>Java</h2>
      ...
      <div class="row featurette">
        <div class="col-md-7 col-md-push-5">
          <h2 class="featurette-heading">Te mantiene <span class="text-muted">motivado</span></h2>
          <p class="lead">Estar en contacto con otros individuos que poseen diversos talentos y personalidades te puede motivar a también aprender cosas nuevas, e incluso puede ocurrir que te motive para dejar algún mal hábito. Convivir con otras personas en un ambiente de cooperación te ayuda a desarrollarte a nivel personal y mantener tu entusiasmo en tus relaciones con los otros. Al compartir tu conocimiento con los otros, también te das cuenta de lo valioso que es aquello que has aprendido. </p>
        </div>
        <div class="col-md-5 col-md-pull-7">
          <br><br><br><br><br><br><img src="img/02.jpg" alt="Generic placeholder image" width="65%" height="65%">
        </div>
      </div>
      ...
      <footer>
        ...
        <p>&copy; Todos los derechos reservados</p><br>
		Desing By Daniel GG<br>
		2017
      </footer>
